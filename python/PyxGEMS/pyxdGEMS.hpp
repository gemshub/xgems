...
void exportChemicalEngineMaps(py::module& m)
{
    ...
    gems.def(py::init<std::string, bool, bool>(), py::arg("input_file"), py::arg("reset_calc")=false, py::arg("cold_start")=true )
            ...
            .def_readwrite("b", &ChemicalEngineMaps::b_amounts)
            ...
            .def("clear", &ChemicalEngineMaps::clear, py::arg("cvalue")=1e-15)
            ...
            //            .def_property_readonly("vector_b", &ChemicalEngineMaps::bulk_composition)
            ...
            .def("reset_aq_composition", &ChemicalEngineMaps::reset_aq_composition)
            .def_property_readonly("solids_elements_moles", &ChemicalEngineMaps::solids_elements_moles)
