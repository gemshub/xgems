...
void exportChemicalEngine(py::module& m)
{
    ...
    py::class_<ChemicalEngine>(m, "ChemicalEngine")
        ...
        .def("initializeJstr", &ChemicalEngine::initializeJstr)
        .def("readDbrFile", &ChemicalEngine::readDbrFile)
        .def("readDbrJstr", &ChemicalEngine::readDbrJstr)
        .def("writeDbrFile", &ChemicalEngine::writeDbrFile)
        .def("writeDbrJstr", &ChemicalEngine::writeDbrJstr)
        ...
        .def("elementAmountsInPhase", &ChemicalEngine::elementAmountsInPhase, py::return_value_policy::reference_internal)
        .def("elementAmountsInSpecies", &ChemicalEngine::elementAmountsInSpecies, py::return_value_policy::reference_internal)
